...
if (empty($dados['nome'])) {
    ...
    $query_usuario = "INSERT INTO datatables (nome, email, Telefone, Cpf, Cep, Rua, Bairro, Nascimento, complemento, Numero, Login, Senha) VALUES (:nome, :email, :Telefone, :Cpf, :Cep, :Rua, :Bairro, :Nascimento, :complemento, :Numero, :Login, :Senha)";
