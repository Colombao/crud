        ...
        <form action="" method="POST" name="CriarPerfil" id="criarPerfil">
            ...
            <div class=" form-group d-flex justify-content-between align-items-center ">
                <div class=" col-md-6 offset-md-3">
                    <button type="submit" class="btn btn-outline-info btn-sm" value="Criar">Editar</button>
                    <button type="submit" class="btn btn-outline-danger btn-sm" value="Criar">Deletar</button>
                </div>
            </div>
        </form>
    </div>
